   ...
   public class Program
    {
...

        {
            ...
            Console.WriteLine("Welcome {0} {1} {2}  Your Balance is {3}", account.FirstName, account.LastName, account.BvnNumber, account.Balance);
            Console.WriteLine();
            ...
            Console.WriteLine("Beginning balance is {0:C}", account.Balance);
